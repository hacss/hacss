...
module.exports = {
    Ac: mapArgs(a => `align-content: ${a}`, lookup({
        fs: "flex-start",
        fe: "flex-end",
        c: "center",
        sb: "space-between",
    ...
    Ai: mapArgs(a => `align-items: ${a}`, lookup({
        fs: "flex-start",
        fe: "flex-end",
        c: "center",
        b: "baseline",
    ...
    Animdir: mapArgs(a => `animation-direction: ${a}`, lookup({
        a: "alternate",
    ...
    Animfm: mapArgs(a => `animation-fill-mode: ${a}`, lookup({ b: "backwards", bo: "both", f: "forwards", n: "none" })),
    Animic: mapArgs(a => `animation-iteration-count: ${a}`, lookup({ i: "infinite" })),
    Animn: mapArgs(a => `animation-name: ${a}`, lookup({ n: "none" })),
    Animps: mapArgs(a => `animation-play-state: ${a}`, lookup({ p: "paused", r: "running" })),
    Animtf: mapArgs(a => `animation-timing-function: ${a}`, lookup({
        e: "ease",
        ei: "ease-in",
        eo: "ease-out",
        eio: "ease-in-out",
    ...
    As: mapArgs(a => `align-self: ${a}`, lookup({
        a: "auto",
        fs: "flex-start",
        fe: "flex-end",
        c: "center",
  ...
  `,
    ...
    Bdcl: mapArgs(a => `border-collapse: ${a}`, lookup({ c: "collapse", s: "separate" })),
    ...
    Bdsp: mapArgs((a, b = "") => `border-spacing: ${a} ${b}`, lookup({ i: "inherit" }), lookup({ i: "inherit" })),
    ...
    *width: auto;
    zoom: 1;
  `,
    Bfv: mapArgs(a => `backface-visibility: ${a}`, lookup({ h: "hidden", v: "visible" })),
    Bg: mapArgs(a => `background: ${a}`, lookup({ n: "none", t: "transparent" })),
    Bga: mapArgs(a => `background-attachment: ${a}`, lookup({ f: "fixed", l: "local", s: "scroll" })),
    Bgc: mapArgs(a => `background-color: ${a}`, color),
    Bgcp: mapArgs(a => `background-clip: ${a}`, lookup({ bb: "border-box", cb: "content-box", pb: "padding-box" })),
    Bgi: mapArgs(a => `background-image: ${a}`, lookup({ n: "none" })),
    Bgo: mapArgs(a => `background-origin: ${a}`, lookup({ bb: "border-box", cb: "content-box", pb: "padding-box" })),
    Bgp: mapArgs((a, b = "") => `background-position: ${a} ${b}`, lookup({
        start_t: "__START__ 0",
        end_t: "__END__ 0",
    ...
    Bgpx: mapArgs(a => `background-position-x: ${a}`, lookup({ start: "__START__", end: "__END__", c: "50%" })),
    Bgpy: mapArgs(a => `background-position-y: ${a}`, lookup({ t: "0", b: "100%", c: "50%" })),
    Bgr: mapArgs(a => `background-repeat: ${a}`, lookup({
        nr: "no-repeat",
        rx: "repeat-x",
        ry: "repeat-y",
        r: "repeat",
    ...
    Bgz: mapArgs(a => `background-size: ${a}`, lookup({ a: "auto", ct: "contain", cv: "cover" })),
    Blur: a => `filter: blur(${a})`,
    Brightness: a => `filter: brightness(${a})`,
    Bxsh: mapArgs(a => `box-shadow: ${a}`, lookup({ n: "none" })),
    Bxz: mapArgs(a => `box-sizing: ${a}`, lookup({ cb: "content-box", pb: "padding-box", bb: "border-box" })),
    Cf: `
    zoom: 1;
    &::before, &::after {
      content: " ";
  ...
  `,
    Cl: mapArgs(a => `clear: ${a}`, lookup({ n: "none", b: "both", start: "__START__", end: "__END__" })),
    C: mapArgs(a => `color: ${a}`, color),
    Cnt: mapArgs(a => `content: ${a}`, lookup({
        n: "none",
        nor: "normal",
        oq: "open-quote",
        cq: "close-quote",
    ...
    Ctn: mapArgs(a => `contain: ${a}`, lookup({
        n: "none",
        st: "strict",
        c: "content",
        z: "size",
  ...
  `,
    ...
    Ff: mapArgs(a => `font-family: ${a}`, lookup({
    ...
    Fl: mapArgs(a => `float: ${a}`, lookup({ n: "none", start: "__START__", end: "__END__" })),
    Fs: mapArgs(a => `font-style: ${a}`, lookup({ n: "normal", i: "italic", o: "oblique" })),
    Fv: mapArgs(a => `font-variant: ${a}`, lookup({ n: "normal", sc: "small-caps" })),
    ...
    Fw: mapArgs(a => `font-weight: ${a}`, lookup({
        100: "100",
        200: "200",
        300: "300",
        400: "400",
    ...
    Fxd: mapArgs(a => `flex-direction: ${a}`, lookup({ r: "row", rr: "row-reverse", c: "column", cr: "column-reverse" })),
    Fxf: mapArgs(a => `flex-flow: ${a}`, lookup({
        r: "row",
        rr: "row-reverse",
        c: "column",
        cr: "column-reverse",
    ...
    Fxg: a => `flex-grow: ${a}`,
    Fxs: a => `flex-shrink: ${a}`,
    Fxw: mapArgs(a => `flex-wrap: ${a}`, lookup({ nw: "nowrap", w: "wrap", wr: "wrap-reverse" })),
    Fz: a => `font-size: ${a}`,
  ...
  `,
    ...
    Hy: mapArgs(a => `hyphens: ${a}`, lookup({ a: "auto", n: "normal", m: "manual" })),
    IbBox: `
    display: inline-block;
    *display: inline;
    zoom: 1;
  ...
  `,
    ...
    Jc: mapArgs(a => `justify-content: ${a}`, lookup({
        fs: "flex-start",
        fe: "flex-end",
        c: "center",
        sb: "space-between",
  ...
  `,
    ...
    Lisp: mapArgs(a => `list-style-position: ${a}`, lookup({ i: "inside", o: "outside" })),
    List: mapArgs(a => `list-style-type: ${a}`, lookup({
        n: "none",
        d: "disc",
        c: "circle",
        s: "square",
    ...
    Mah: mapArgs(a => `max-height: ${a}`, lookup({
        a: "auto",
        maxc: "max-content",
        minc: "min-content",
        fa: "fill-available",
    ...
    Maw: mapArgs(a => `max-width: ${a}`, lookup({
        n: "none",
        fa: "fill-available",
        fc: "fit-content",
        maxc: "max-content",
    ...
    Mx: mapArgs(a => `margin-__START__: ${a}; margin-__END__: ${a}`, lookup({ 0: "0", a: "auto" })),
    My: mapArgs(a => `margin-top: ${a}; margin-bottom: ${a}`, lookup({ 0: "0", a: "auto" })),
    Objf: mapArgs(a => `object-fit: ${a}`, lookup({
        ct: "contain",
        cv: "cover",
        f: "fill",
        n: "none",
    ...
    Pos: mapArgs(a => `position: ${a}`, lookup({
        a: "absolute",
        f: "fixed",
        r: "relative",
        s: "static",
    ...
    Prso: mapArgs((a, b) => `perspective-origin: ${a} ${b}`, lookup(transformOrPerspectiveOrigins), lookup(transformOrPerspectiveOrigins)),
    ...
    *width: auto;
    zoom: 1;
  `,
    Rsz: mapArgs(a => `resize: ${a}`, lookup({ n: "none", b: "both", h: "horizontal", v: "vertical" })),
    ...
    Stklc: mapArgs(a => `stroke-linecap: ${a}`, lookup({ i: "inherit", b: "butt", r: "round", s: "square" })),
    Stklj: mapArgs(a => `stroke-linejoin: ${a}`, lookup({ i: "inherit", b: "bevel", r: "round", m: "miter" })),
  ...
  `,
    ...
    Ta: mapArgs(a => `text-align: ${a}`, lookup({
        c: "center",
        e: "end",
        end: "__END__",
        j: "justify",
    ...
    Tal: mapArgs(a => `text-align-last: ${a}`, lookup({
        a: "auto",
        c: "center",
        e: "end",
        end: "__END__",
    ...
    Td: mapArgs(a => `text-decoration: ${a}`, lookup({ lt: "line-through", n: "none", o: "overline", u: "underline" })),
    Ti: a => `text-indent: ${a}`,
    Tov: mapArgs(a => `text-overflow: ${a}`, lookup({ c: "clip", e: "ellipsis" })),
    ...
    Tren: mapArgs(a => `text-rendering: ${a}`, lookup({
        a: "auto",
        os: "optimizeSpeed",
        ol: "optimizeLegibility",
        gp: "geometricPrecision",
    })),
    Trfo: mapArgs((a, b) => `transform-origin: ${a} ${b}`, lookup(transformOrPerspectiveOrigins), lookup(transformOrPerspectiveOrigins)),
    Trfs: mapArgs(a => `transform-style: ${a}`, lookup({ f: "flat", p: "preserve-3d" })),
    ...
    Trstf: mapArgs(a => `transition-timing-function: ${a}`, lookup({
        e: "ease",
        ei: "ease-in",
        eo: "ease-out",
        eio: "ease-in-out",
    ...
    Tt: mapArgs(a => `text-transform: ${a}`, lookup({ n: "none", c: "capitalize", u: "uppercase", l: "lowercase" })),
    Us: mapArgs(a => `user-select: ${a}`, lookup({
        a: "all",
        el: "element",
        els: "elements",
        n: "none",
    ...
    Va: mapArgs(a => `vertical-align: ${a}`, lookup({
        b: "bottom",
        bl: "baseline",
        m: "middle",
        sub: "sub",
    ...
    V: mapArgs(a => `visibility: ${a}`, lookup({ v: "visible", h: "hidden", c: "collapse" })),
    W: mapArgs(a => `width: ${a}`, [
        normalizeLength,
        lookup({
            0: "0",
    ...
    Whs: mapArgs(a => `white-space: ${a}`, lookup({
        n: "normal",
        p: "pre",
        nw: "nowrap",
        pw: "pre-wrap",
    ...
    Whsc: mapArgs(a => `white-space-collapse: ${a}`, lookup({
        n: "normal",
        ka: "keep-all",
        l: "loose",
        bs: "break-strict",
    ...
    Wob: mapArgs(a => `word-break: ${a}`, lookup({ ba: "break-all", ka: "keep-all", n: "normal" })),
    Wow: mapArgs(a => `word-wrap: ${a}`, lookup({ bw: "break-word", n: "normal" })),
